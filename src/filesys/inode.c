            ...
            for (; i < sectors; i++) {
                ...
                /* Now the case where its a single indirect node */
                    ...
                    if (pos_index == 0) {
                        ...
                        /*printf("New indirect with sector: %d\n", single_sector.sector);*/
